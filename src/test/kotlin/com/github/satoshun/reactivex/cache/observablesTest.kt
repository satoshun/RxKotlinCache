...
class ObservablesTest {
  ...
  fun cache1() {
    ...
    val original = object : Function1<Int, Observable<String>> {
      override fun invoke(p1: Int): Observable<String> {
        counter += p1
        return Observable.just(p1.toString(), (p1 + 1).toString())
      }
    }
  ...
  fun cache2() {
    var counter = 0
    val original = object : Function2<Int, Int, Observable<String>> {
      override fun invoke(p1: Int, p2: Int): Observable<String> {
        counter += p1 + p2
        return Observable.just(p1.toString(), (p1 + 1).toString())
      }
    }
  ...
  fun cache3() {
    var counter = 0
    val original = object : Function3<Int, Int, Int, Observable<String>> {
      override fun invoke(p1: Int, p2: Int, p3: Int): Observable<String> {
        counter += p1 + p2 + p3
        return Observable.just(p1.toString(), (p1 + 1).toString())
      }
    }
  ...
  fun cache4() {
    var counter = 0
    val original = object : Function4<Int, Int, Int, Int, Observable<String>> {
      override fun invoke(p1: Int, p2: Int, p3: Int, p4: Int): Observable<String> {
        counter += p1 + p2 + p3 + p4
        return Observable.just(p1.toString(), (p1 + 1).toString())
      }
    }
