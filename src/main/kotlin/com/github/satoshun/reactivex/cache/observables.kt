...
fun <R : Any> rxCache(original: () -> Observable<R>): ObservableCache0<R> {
  return ObservableCache0(original)
}

class ObservableCache0<R : Any>(
    private val original: () -> Observable<R>
...
fun <P1, R : Any> rxCache(original: (P1) -> Observable<R>): ObservableCache1<P1, R> {
  return ObservableCache1(original)
}

class ObservableCache1<in P1, R : Any>(
    private val original: (P1) -> Observable<R>
...
fun <P1, P2, R : Any> rxCache(original: (P1, P2) -> Observable<R>): ObservableCache2<P1, P2, R> {
  return ObservableCache2(original)
}

class ObservableCache2<in P1, in P2, R : Any>(
    private val original: (P1, P2) -> Observable<R>
...
fun <P1, P2, P3, R : Any> rxCache(original: (P1, P2, P3) -> Observable<R>): ObservableCache3<P1, P2, P3, R> {
  return ObservableCache3(original)
}

class ObservableCache3<in P1, in P2, in P3, R : Any>(
    private val original: (P1, P2, P3) -> Observable<R>
...
fun <P1, P2, P3, P4, R : Any> rxCache(original: (P1, P2, P3, P4) -> Observable<R>): ObservableCache4<P1, P2, P3, P4, R> {
  return ObservableCache4(original)
}

class ObservableCache4<in P1, in P2, in P3, in P4, R : Any>(
    private val original: (P1, P2, P3, P4) -> Observable<R>
