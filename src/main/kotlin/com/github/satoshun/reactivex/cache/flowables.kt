...
fun <R : Any> rxCache(original: () -> Flowable<R>): FlowableCache0<R> {
  return FlowableCache0(original)
}

class FlowableCache0<R : Any>(
    private val original: () -> Flowable<R>
...
fun <P1, R : Any> rxCache(original: (P1) -> Flowable<R>): FlowableCache1<P1, R> {
  return FlowableCache1(original)
}

class FlowableCache1<in P1, R : Any>(
    private val original: (P1) -> Flowable<R>
...
fun <P1, P2, R : Any> rxCache(original: (P1, P2) -> Flowable<R>): FlowableCache2<P1, P2, R> {
  return FlowableCache2(original)
}

class FlowableCache2<in P1, in P2, R : Any>(
    private val original: (P1, P2) -> Flowable<R>
...
fun <P1, P2, P3, R : Any> rxCache(original: (P1, P2, P3) -> Flowable<R>): FlowableCache3<P1, P2, P3, R> {
  return FlowableCache3(original)
}

class FlowableCache3<in P1, in P2, in P3, R : Any>(
    private val original: (P1, P2, P3) -> Flowable<R>
...
fun <P1, P2, P3, P4, R : Any> rxCache(original: (P1, P2, P3, P4) -> Flowable<R>): FlowableCache4<P1, P2, P3, P4, R> {
  return FlowableCache4(original)
}

class FlowableCache4<in P1, in P2, in P3, in P4, R : Any>(
    private val original: (P1, P2, P3, P4) -> Flowable<R>
